// Restored helper methods for HomePage after hotfix refactor
...
extension _HomeHelpers on _HomePageState {
  ...
  Widget _buildGlassRecentTransactions(BuildContext context, MoneyModel model, bool isDark, bool isCompact) {
    ...
    if (recent.isEmpty) {
      return Center(child: Text('Nessuna transazione', style: TextStyle(color: isDark ? Colors.white60 : Colors.grey[600])));
    }
